...
PACKAGE Rr_Type IS
   ...
   function ConvertDomainNameToWire(DomainNameVersion: in DomainNameStringType) return WireStringType;
   --# return Name => (for all I in DomainNameStringTypeIndex => (Character'Pos(Name(I)) >= 0 and Character'Pos(Name(I)) <= 255));
   ...
   BlankOwner : constant WireStringType := ASCII.NUL & "empty.A.resource.record         " &
