...
with Ada.Text_IO;
   ...
   --For now, only {A,AAAA,CNAME,DNSKEY,MX,SRV,NS,PTR,SOA} records recognized
   ...
   begin
      ...
      elsif firstChar = 'P' and lastChar = 'R' and begIdx <= endIdx-2 and lengthToken = 3 then
      ...
      --SOA
      --formulation of third condition helps prover
      elsif firstChar = 'S' and lastChar = 'A' and begIdx <= endIdx-2  and lengthToken = 3 then
      ...
      --SRV
      --formulation of third condition helps prover
      elsif firstChar = 'S' and lastChar = 'V' and begIdx <= endIdx-2 and lengthToken = 3 then
      ...
      --TXT
      --formulation of third condition helps prover
      elsif firstChar = 'T' and lastChar = 'T' and begIdx <= endIdx-2 and lengthToken = 3 then
      ...
      --AAAA
      --formulation of third condition helps prover
      elsif firstChar = 'A' and lastChar = 'A' and begIdx <= endIdx-3 and lengthToken = 4 then
      ...
      --NSEC
      --formulation of third condition helps prover
      elsif firstChar = 'N' and lastChar = 'C' and begIdx <= endIdx-3 and lengthToken = 4 then
      ...
      --CNAME
      --formulation of third condition helps prover
      elsif firstChar = 'C' and lastChar = 'E' and begIdx <= endIdx-4 and lengthToken = 5 then
      ...
      --RRSIG
      --formulation of third condition helps prover
      elsif firstChar = 'R' and lastChar = 'G' and begIdx <= endIdx-4 and lengthToken = 5 then
      ...
      --DNSKEY
      --formulation of third condition helps prover
      elsif firstChar = 'D' and lastChar = 'Y' and begIdx <= endIdx-5 and lengthToken = 6 then
         if Ada.Characters.Handling.to_upper(s(begIdx+1)) = 'N' and
            Ada.Characters.Handling.To_Upper(S(BegIdx+2)) = 'S' and
   ...
   --Called only when s(begIdx..endIdx) is valid record type indicator
    --For now, only {A,AAAA,CNAME,DNSKEY,MX,SRV,NS,NSEC,PTR,SOA} records supported
    --{RP,TXT recognized but not implemented}
 ...
 procedure checkValidHostName(Name: Rr_Type.DomainNameStringType; success: in out boolean)
   ...
   procedure CheckValidSRVOwner(Name: Rr_Type.DomainNameStringType; success: in out boolean)
      is
         Length: Rr_Type.DomainNameStringTypeIndex;
         retVal : boolean := true;
      ...
      begin
         ...
         -- 3. Position of first '.' should be at least 7 characters from the end of the string
